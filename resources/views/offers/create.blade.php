    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class="flex-center position-ref full-height">
            ...
            <div class="content">
                ...
                {{__('messages.Add your offer')}} <!-- translate multi language -->
                </div>
        ...
        @endif
                <br>
               <form method="POST" action="{{route('offers.store')}}"><!--{{route('offers.store')}}->hayda name tab3e l route  -->
               @csrf
            ...
            <div class="form-group">
                ...
                <div class="form-group ">
                    <label for="email" class="">{{__('messages.Offer Price')}}</label>
            ...
            <div class="form-group">
                ...
                <button typr="submite" class="btn btn-primary"> {{__('messages.Save Offer')}}</button>
               </form> 
            </div>
        </div>
    </body>
